...
public class Bicing {
     ...
     *  
     * @param est Number of stations
     * @param bic Number of bicycles
     * @param dem Type of demand
     */
    public Bicing(int est, int bic, int dem) {
  ...
  /**
     ...
     * @return Number of bicycles that don not move from the station the current hour
     */
     ...
     *
     * @param st Station number
     * @return Number of bicycles of an station the next hour
     */
     ...
     *
     * @param st Station number
     * @return Demand of bicycles for the next hour
     */
