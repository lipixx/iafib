...
(defrule imprimeix-generes-puntuats;;imprimeix generes amb punts diferents de 0, per debug
	(declare (salience 6))
...
(defrule imprimeix-continguts-puntuats
	(declare (salience 7))
...
;; 			(bind ?j (+ ?j 2))
;; 		)
;; 		(bind ?*llista-CP-ordenada* (insert$ ?*llista-CP-ordenada* (+ (length$ ?*llista-CP-ordenada*) 1) ?titolMax))
